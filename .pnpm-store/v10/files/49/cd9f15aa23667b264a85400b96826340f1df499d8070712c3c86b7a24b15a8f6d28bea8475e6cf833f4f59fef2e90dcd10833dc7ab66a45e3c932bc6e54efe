...
type TavilySearchParamsWithSimpleImages = TavilySearchParamsBase & {
  /**
...
type TavilySearchParamsWithImageDescriptions = TavilySearchParamsBase & {
  /**
   * Also perform an image search and include the results in the response.
   */
  include_images?: true;
...
type TavilySearchParams = TavilySearchParamsWithSimpleImages | TavilySearchParamsWithImageDescriptions;
/**
...
type CrawlCategory = "Documentation" | "Blog" | "Blogs" | "Community" | "About" | "Contact" | "Privacy" | "Terms" | "Status" | "Pricing" | "Enterprise" | "Careers" | "E-Commerce" | "Authentication" | "Developer" | "Developers" | "Solutions" | "Partners" | "Downloads" | "Media" | "Events" | "People";
 ...
 */
type TavilySearchResponseWithImageDescriptions = TavilyBaseSearchResponse & {
  /**
 ...
 */
type TavilySearchResponseWithSimpleImages = TavilyBaseSearchResponse & {
  /**
   * List of query-related images. If {@link TavilySearchParams.include_image_descriptions} is
   * `true`, each item will be an object with `url` and `description` properties. Otherwise, each
   * item will be a string containing the URL of the image.
...
type TavilySearchResponse = TavilySearchResponseWithImageDescriptions | TavilySearchResponseWithSimpleImages;
/**
...
type TavilyGetIncompleteResearchResponse = Pick<TavilyGetResearchResponse, "request_id" | "status" | "response_time">;
/**
 ...
 */
declare class TavilySearchAPIWrapper extends BaseTavilyAPIWrapper {
  /**
 ...
 */
declare class TavilyExtractAPIWrapper extends BaseTavilyAPIWrapper {
  /**
 ...
 */
declare class TavilyCrawlAPIWrapper extends BaseTavilyAPIWrapper {
  /**
 ...
 */
declare class TavilyMapAPIWrapper extends BaseTavilyAPIWrapper {
  /**
 ...
 */
declare class TavilyResearchAPIWrapper extends BaseTavilyAPIWrapper {
  /**
   ...
   */
  rawResults(params: TavilyResearchParams): Promise<TavilyResearchQueueResponse | AsyncGenerator<Buffer, void, unknown>>;
  /**
   ...
   */
  getResearch(requestId: string): Promise<TavilyGetResearchResponse>;
}
//#endregion
export { CrawlCategory, ExtractDepth, TavilyBaseSearchResponse, TavilyCrawlAPIWrapper, TavilyCrawlParams, TavilyCrawlResponse, TavilyExtractAPIWrapper, TavilyExtractParams, TavilyExtractResponse, TavilyExtractResult, TavilyFailedResult, TavilyGetIncompleteResearchResponse, TavilyGetResearchResponse, TavilyMapAPIWrapper, TavilyMapParams, TavilyMapResponse, TavilyResearchAPIWrapper, TavilyResearchParams, TavilyResearchQueueResponse, TavilySearchAPIWrapper, TavilySearchParams, TavilySearchResponse, TavilySearchResponseWithImageDescriptions, TavilySearchResponseWithSimpleImages };
