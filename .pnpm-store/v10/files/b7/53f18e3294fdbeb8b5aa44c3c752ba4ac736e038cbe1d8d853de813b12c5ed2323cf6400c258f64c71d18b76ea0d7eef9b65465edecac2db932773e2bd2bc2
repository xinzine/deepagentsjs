...
const inputSchema = zod_v3.z.object({ requestId: zod_v3.z.string().describe("The unique identifier of the research task.") });
/**
...
* ```
*/
var TavilyGetResearch = class extends __langchain_core_tools.StructuredTool {
	static lc_name() {
...
//#endregion
exports.TavilyGetResearch = TavilyGetResearch;
//# sourceMappingURL=tavily-get-research.cjs.map