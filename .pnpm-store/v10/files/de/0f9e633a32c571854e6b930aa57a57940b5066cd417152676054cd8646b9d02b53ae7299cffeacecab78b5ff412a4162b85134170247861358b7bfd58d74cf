...
const outputSchemaPropertySchema = z.lazy(() => z.object({
	type: z.enum([
		"object",
		"string",
		"integer",
	...
	properties: z.record(outputSchemaPropertySchema).optional(),
	items: z.object({ type: z.enum([
		"object",
		"string",
		"integer",
		"number",
...
const inputSchema = z.object({
	...
	outputSchema: z.object({
      ...
      `),
	stream: z.boolean().optional().describe(`Whether to stream the research results as they are generated. 
      When 'true', returns a Server-Sent Events (SSE) stream.
      Default is false.
      `),
	citationFormat: z.enum([
		"numbered",
		"mla",
		"apa",
		"chicago"
...
* ```
*/
var TavilyResearch = class extends StructuredTool {
	static lc_name() {
...
//#endregion
export { TavilyResearch };
//# sourceMappingURL=tavily-research.js.map