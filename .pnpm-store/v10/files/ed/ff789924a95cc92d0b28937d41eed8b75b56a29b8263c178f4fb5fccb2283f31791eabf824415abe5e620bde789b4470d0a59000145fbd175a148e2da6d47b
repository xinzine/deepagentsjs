...
var BaseTavilyAPIWrapper = class {
	...
	*/
	constructor(fields) {
		const apiKey = fields.tavilyApiKey ?? (0, __langchain_core_utils_env.getEnvironmentVariable)("TAVILY_API_KEY");
...
exports.TavilyResearchAPIWrapper = TavilyResearchAPIWrapper;
