 ...
 */
declare function computer_20251124(options: Computer20251124Options): DynamicStructuredTool<zod.ZodDiscriminatedUnion<[zod.ZodObject<{
  action: zod.ZodLiteral<"screenshot">;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"left_click">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"right_click">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"middle_click">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"double_click">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"triple_click">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"left_click_drag">;
  start_coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
  end_coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"left_mouse_down">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"left_mouse_up">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"scroll">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
  scroll_direction: zod.ZodEnum<{
    down: "down";
    left: "left";
    right: "right";
    up: "up";
  }>;
  scroll_amount: zod.ZodNumber;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"type">;
  text: zod.ZodString;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"key">;
  key: zod.ZodString;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"mouse_move">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"hold_key">;
  key: zod.ZodString;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"wait">;
  duration: zod.ZodOptional<zod.ZodNumber>;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"zoom">;
  region: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber, zod.ZodNumber, zod.ZodNumber], null>;
}, zod_v4_core0.$strip>], "action">, Computer20251124Action, any, ToolMessage<any>, unknown, string>;
/**
 ...
 * @returns The computer use tool object that can be passed to `bindTools`
 */
declare function computer_20250124(options: Computer20250124Options): DynamicStructuredTool<zod.ZodDiscriminatedUnion<[zod.ZodObject<{
  action: zod.ZodLiteral<"screenshot">;
}, zod_v4_core0.$strip>, zod.ZodObject<{
  action: zod.ZodLiteral<"left_click">;
  coordinate: zod.ZodTuple<[zod.ZodNumber, zod.ZodNumber], null>;
  ...
  action: zod.ZodLiteral<"wait">;
  duration: zod.ZodOptional<zod.ZodNumber>;
}, zod_v4_core0.$strip>], "action">, Computer20250124Action, any, ComputerUseReturnType, unknown, string>;
//#endregion
