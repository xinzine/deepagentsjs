...
class PortApi extends base_1.BaseAPI {
     ...
     */
    getPorts(options) {
        return (0, exports.PortApiFp)(this.configuration).getPorts(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Check if a specific port is currently in use
     * @summary Check if port is in use
     ...
     */
    isPortInUse(port, options) {
        return (0, exports.PortApiFp)(this.configuration).isPortInUse(port, options).then((request) => request(this.axios, this.basePath));
    }
}
